import { Outlet, Link, Form, useLoaderData, NavLink } from "react-router";
import type { Route } from "./+types/layout";
import { requireStaffAuth, staffSessionCookie } from "~/lib/session.server";
    ...
    <div className="min-h-screen bg-gray-900">
      ...
      <aside className="fixed inset-y-0 left-0 w-64 bg-gray-800 border-r border-gray-700 flex flex-col">
        ...
        <div className="flex items-center gap-3 px-6 py-5 border-b border-gray-700 flex-shrink-0">
          ...
          <div>
            <h1 className="font-bold text-white">GymAdmin</h1>
        ...
        <div className="p-4 border-t border-gray-700 flex-shrink-0">
          ...
          <Form method="post">
            ...
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-2 px-4 py-2 text-sm text-gray-300 hover:text-white hover:bg-gray-700 rounded-lg transition"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
